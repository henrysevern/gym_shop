"""
Django settings for gym_shop project.
...
DATABASES = {
    'default': dj_database_url.parse('postgres://ghacuwws:zzjWXJafOc49qn2IZF7fZ7Bx9t0aQsA9@rogue.db.elephantsql.com/ghacuwws')
}
...
if 'USE_AWS' in os.environ:
    ...
    # Bucket Config
    AWS_STORAGE_BUCKET_NAME = 'gym-shop'
